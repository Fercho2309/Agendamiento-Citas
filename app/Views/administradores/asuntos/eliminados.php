...
<html lang="en">
    <head>
        ...
        <title>Eliminados Asuntos</title>
    </head>
    <body>
    ...
    <div class="contenedor">
        <div class="limite">
            ...
            <div class="d-flex justify-content-center" id="contenedorTitle">       
                ...
                <h1 id="title">Administrador de Asuntos Eliminados</h1>
            </div>
            ...
            <div>
                ...
                <div id="btns">
                    ...
                    <a href="<?php echo base_url("/asuntos")?>" id="regresar" class="btn btn-primary">Regresar</a>
                ...
                <table id="example" class="table" style="width:100%">
                    ...
                    <tbody style="font-family:Arial;font-size:17px;">
                        ...
                        <tr>
                            ...
                            <td id="detalles">
                                <input href="#" data-href="<?php echo base_url('/eliminar_Asunto') . '/' .$dato['id_asunto']. '/' .'A'; ?>" data-bs-toggle="modal" data-bs-target="#ModalConfirmar" type="image" src="<?php echo base_url('img/refresh-ccw.svg'); ?>" width="16" height="16" title="Activar Registro"></input>
                             </td>
