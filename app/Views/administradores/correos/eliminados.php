        ...
        <div id="contenedor">
            <div id="limite" class="border border-3">
                ...
                <div class="d-flex justify-content-center" id="contenedorTitle">       
                    ...
                    <h1 id="title">Administrador de Correos Eliminados</h1>
                </div>
                ...
                <div>
                    ...
                    <div id="btns">
                        ...
                        <a href="<?php echo base_url('/correos')?>" id="regresar" class="btn btn-primary">Regresar</a>
                        ...
                        <tbody style="font-family:Arial;font-size:17px;">
                            <?php foreach ($correos as $dato) { ?>
                                <tr>
                                    ...
                                    <td id="detalles">
                                        <input href="#" data-href="<?php echo base_url('/eliminar_Correos') . '/' .$dato['id_correo']. '/' .'A'; ?>" data-bs-toggle="modal" data-bs-target="#ModalConfirmar" type="image" src="<?php echo base_url('img/refresh-ccw.svg'); ?>" width="16" height="16" title="Activar Registro"></input>
                                    </td>
