    ...
    <div class="contenedor">
        <div class="limite">
            ...
            <div class="d-flex justify-content-center" id="contenedorTitle">       
                ...
                <h1 id="title">Administrador de Roles Eliminados</h1>
            </div>
            ...
            <div>
                ...
                <div id="btns">
                    ...
                    <a href="<?php echo base_url("/roles")?>" id="regresar" class="btn btn-primary">Regresar</a>
                    ...
                    <tbody style="font-family:Arial;font-size:17px;">
                        <?php foreach ($roles as $dato) { ?>
                            <tr>
                                ...
                                <td id="detalles">
                                    <input href="#" data-href="<?php echo base_url('/eliminar_rol') . '/' .$dato['id_rol']. '/' .'A'; ?>" data-bs-toggle="modal" data-bs-target="#ModalConfirmar" type="image" src="<?php echo base_url('img/refresh-ccw.svg'); ?>" width="16" height="16" title="Activar Registro"></input>
                                </td>
                        <?php } ?>
                    </tbody>
                </table>
...
<script>  
    ...
    function eliminaRol(id){
        $("#id_rol").val(id);
        dataURL = "<?php echo base_url('elimina_Rol'); ?>" + "/" + id + "/" + 'A';
        $.ajax({
            type:"POST",
            url: dataURL,
            datatype: "json",
