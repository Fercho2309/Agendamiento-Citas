        ...
        <div id="contenedor">
            <div id="limite" class="border border-3">
                ...
                <div class="d-flex justify-content-center" id="contenedorTitle">
                    ...
                    <h1 id="title">Administrador de Telefonos Eliminados</h1>
                </div>
                ...
                <div>
                    ...
                    <div id="btns">
                        ...
                        <a href="<?php echo base_url("/telefonos")?>" id="regresar" class="btn btn-primary">Regresar</a>
                        ...
                        <tbody style="font-family:Arial;font-size:17px;">
                            ...
                            foreach ($telefonos as $dato) { ?>
                                ...
                                <td><?php echo $dato['id_telefono']; ?></td>
                                    ...
                                    <td id="detalles">
                                        <input href="#" data-href="<?php echo base_url('/eliminar_Telefonos') . '/' .$dato['id_telefono']. '/' .'A'; ?>" data-bs-toggle="modal" data-bs-target="#ModalConfirmar" type="image" src="<?php echo base_url('img/refresh-ccw.svg'); ?>" width="16" height="16" title="Activar Registro"></input>
                                    </td>
