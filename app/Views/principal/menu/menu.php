...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url("css/principal/Headercopys.css")?>">
    ...
    <div class="limite1">
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" data-bs-backdrop="static" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
            ...
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasExampleLabel">EduCitas</h5>
            ...
            <div class="offcanvas-body" id="canvabody">
                ...
                <ul class="list-items">
                    ...
                    <?php if($User_session->id_rol !== '5' || $User_session->id_rol !== '4'):?>
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="<?= base_url("/buzonEntrada") ?>"><i class="fa-solid fa-envelope"></i> Buzon de Citas</a>
                            </li>
                        <?php endif; ?>
